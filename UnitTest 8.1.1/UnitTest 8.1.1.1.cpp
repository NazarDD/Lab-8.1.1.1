...
#include "../Lab 8.1.1/Lab 8.1.1.1.cpp"
...
namespace YourProjectTests
{
    ...
    public:
        TEST_METHOD(TestCount)
        {
            ...
            Assert::AreEqual(Count(str1), 3);

            char str2[] = "abc while def while ghi";
            Assert::AreEqual(Count(str2), 2);

            char str3[] = "no occurrences";
            Assert::AreEqual(Count(str3), 0);
        }
        ...
        TEST_METHOD(TestChange)
        {
            ...
            char str2[100] = "feg while bnm while utu";
            dest = new char[151];
            dest = Change(str2);
            Assert::AreEqual(dest, "feg *** bnm *** utu");
